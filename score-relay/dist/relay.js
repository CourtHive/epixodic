import { updateMatch, setMatchHistory, getMatch, getActiveMatchIds, getMatchUpsByTournament, pruneStaleMatches, setClockAnchor, getClockAnchor, setClockTimer, clearClockTimer, } from './matchUpStore.js';
...
export function createRelay(io, config) {
    ...
    // clear the timer.
    function startClockTicker(matchUpId, ns) {
        ...
        const timer = setInterval(() => {
            ...
            const activeDone = (anchor.activeClock === 'bolt' && boltMs <= 0) ||
